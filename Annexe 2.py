...
seuil_critique = 0.4 # Choix arbitraire du seil où la probabilité que l'état soit alarmant 
...
for annee in range(1,duree_simulation+1):
     ...
     if etat_actuel[2] > seuil_critique :
         budget_total = budget_total + couts[1]
...
plt.title("Évolution du coût cumulé (Stratégie Préventive)")
plt.xlabel("Années")
